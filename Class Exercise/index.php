        ...
        <div class="app__wrapper">
            ...
            <form action="display.php" method="post">
                ...
                <div class="form_app_submit_container">
                    <button type="submit" class="form_app_submit btn_blue" name='next' onclick="location.href='display.php';">Next <span class="next_arrow_icon"><img src="dist/images/svg/arrow_right_white.svg" alt=""></span></button>
                </div>
